...
MonMenuIconPals:
	...
	icon_pals BLUE, PURPLE ; GOLDEEN
	icon_pals BLUE, PURPLE; SEAKING
	...
	icon_pals GREEN, BROWN ; HOPPIP
	icon_pals GREEN, BROWN; SKIPLOOM
	icon_pals GREEN, BROWN; JUMPLUFF
	icon_pals BLUE, PURPLE; AIPOM
